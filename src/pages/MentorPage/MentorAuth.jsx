...
import MentorLogin from '../../components/MentorComponent/MentorLogin';
import MentorSignup from '../../components/MentorComponent/MentorSignup';
  ...
  return (
    <View style={styles.AuthBack}>
      ...
      <View style={styles.Bar}>
        {/* 선택된 폼 표시 */}
        {auth === 'signup' ? <MentorSignup /> : <MentorLogin />}
